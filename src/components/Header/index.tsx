...
const Header = () => {
    ...
    const { user, authenticated, handleLogout } = useAppContext().auth
    ...
    useEffect(() => {
        const checkAuthentication = () => {
            setIsAuthenticated(
                pathname.includes("perfil") && authenticated && user ? true : false
            )
        }
    ...
    return (
        <header
            ...
            <Container className={styles.header__container}>
                ...
                <div className={styles.header__navigation + (menuIsOpen ? ` ${styles.openMenu}` : "")}>
                    <nav>
                        {isAuthenticated &&
